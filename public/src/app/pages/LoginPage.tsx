...
import { Eye, EyeOff, Percent, Gift, Truck, Sparkles, ArrowRight } from "lucide-react";
        ...
        >
          ...
          <div className="flex-1 px-8 sm:px-12 py-10 sm:py-14 relative">
            ...
            <p className="mt-2 text-[14.5px] text-[#888]">
              Sign in to access your account, orders & member perks.
            </p>
            ...
            <div className="flex items-center gap-3 my-7">
              ...
              <span className="text-[11px] text-[#ccc] uppercase tracking-widest" style={{ fontWeight: 600 }}>or sign in with email</span>
              <div className="flex-1 h-px bg-[#f0eeec]" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="text-right -mt-2">
                <Link
                  to="/forgot-password"
                  className="text-[12px] text-[#C8A08C] hover:text-[#b8907c] transition-colors"
                  style={{ fontWeight: 600 }}
                >
                  Forgot password?
                </Link>
